...
interface SupplierCardProps {
  ...
  setOpenDeleteConfirm: any,

  openSupplierEdit: boolean,
  setOpenSupplierEdit: any,

  openSupplierDetails: boolean,
  setOpenSupplierDetails: any
}
...
export default function SupplierCard(SupplierCardProps: SupplierCardProps) {
  ...
  return <div className="card">
    ...
    <div className="card-itens">
      ...
      <svg onClick={() => {
        SupplierCardProps.setOpenSupplierDetails(!SupplierCardProps.openSupplierDetails)
        SupplierCardProps.onDetailsClick(SupplierCardProps.supplierId)
      }} 
      ...
      <svg onClick={() => {
        SupplierCardProps.setOpenDeleteConfirm(!SupplierCardProps.openDeleteConfirm)
        SupplierCardProps.onDeleteClick(SupplierCardProps.supplierId)
      }} 
